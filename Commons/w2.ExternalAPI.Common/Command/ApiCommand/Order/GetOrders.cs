/*
=========================================================================================================
  Module      : GetOrdersコマンドクラス(GetOrders.cs)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
namespace w2.ExternalAPI.Common.Command.ApiCommand.Order
{
	...
	/// GetOrdersコマンドクラス
	/// </summary>
	public class GetOrders : ApiCommandBase 
	{
		...
		{
			GetOrdersArg arg = (GetOrdersArg) apiCommandArg;
			...
			// 注文情報を取得
			DataTable dataTable = orderCommon.GetOrders(arg.CreatedTimeSpan,
															arg.UpdatedTimeSpan,
															arg.OrderStatus,
															arg.OrderId,
			...
			return new GetOrdersResult(EnumResultStatus.Complete, dataTable);
		}
		#endregion
	}
	#endregion
	...
	/// GetOrdersコマンド用引数クラス
	/// </summary>
	public class GetOrdersArg : ApiCommandArgBase
	{
		#region プロパティ
	...
	#region Result
	/// <summary>
	/// GetOrdersコマンド用実行結果クラス
	/// </summary>
	public class GetOrdersResult : ApiCommandResult
	{
		#region コンストラクタ
		/// <summary>
		/// コンストラクタ
		...
		public GetOrdersResult(EnumResultStatus enumResultStatus, DataTable dataTable) : base(enumResultStatus)
		{
