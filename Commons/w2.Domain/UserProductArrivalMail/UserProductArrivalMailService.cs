/*
=========================================================================================================
  Module      : 入荷通知メールサービス (UserProductArrivalMailService.cs)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
namespace w2.Domain.UserProductArrivalMail
{
	...
	/// 入荷通知メールサービス
	/// </summary>
	public class UserProductArrivalMailService : ServiceBase
	{
		#region +マスタ出力
		/// <summary>
		/// CSVへ出力
			...
			string replacePrice)
		{
			...
			using (var repository = new UserProductArrivalMailRepository(accessor))
		...
		{
			var statementName = GetStatementNameInfo(setting.MasterKbn);
			using (var repository = new UserProductArrivalMailRepository())
			{
			...
			try
			{
				using (var repository = new UserProductArrivalMailRepository())
				{
					repository.CheckFieldsForGetMaster(
						new Hashtable { { Constants.FIELD_USERPRODUCTARRIVALMAIL_SHOP_ID, shopId } },
						masterKbn,
						new KeyValuePair<string, string>("@@ fields @@", sqlFieldNames));
				}
			}
