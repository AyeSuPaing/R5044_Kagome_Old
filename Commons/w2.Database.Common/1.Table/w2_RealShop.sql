if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[w2_RealShop]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[w2_RealShop]
GO
/*
=========================================================================================================
  Module      : リアル店舗情報マスタ(w2_RealShop.sql)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
  Copyright   : Copyright W2 Co.,Ltd. 2013 All Rights Reserved.
=========================================================================================================
*/
CREATE TABLE [dbo].[w2_RealShop] (
...
ALTER TABLE [dbo].[w2_RealShop] WITH NOCHECK ADD
	CONSTRAINT [PK_w2_RealShop] PRIMARY KEY  CLUSTERED
	(
		[real_shop_id]
	) ON [PRIMARY]
GO

CREATE INDEX [IX_w2_RealShop_1] ON [dbo].[w2_RealShop]([name]) ON [PRIMARY]
GO

CREATE INDEX [IX_w2_RealShop_2] ON [dbo].[w2_RealShop]([name_kana]) ON [PRIMARY]
GO

/*
ALTER TABLE [w2_RealShop] ADD [brand_id] [nvarchar] (30) NOT NULL DEFAULT (N'');
ALTER TABLE [w2_RealShop] ADD [area_id] [nvarchar] (30) NOT NULL DEFAULT (N'');
ALTER TABLE [w2_RealShop] ADD [longitude] [decimal] (9,6);
ALTER TABLE [w2_RealShop] ADD [latitude] [decimal] (9,6);
*/
