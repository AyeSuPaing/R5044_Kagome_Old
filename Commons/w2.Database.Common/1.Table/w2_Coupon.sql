if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[w2_Coupon]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[w2_Coupon]
GO
/*
=========================================================================================================
  Module      : クーポンテーブル (w2_Coupon.sql)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
  Copyright   : Copyright W2 Co.,Ltd. 2017 All Rights Reserved.
=========================================================================================================
*/
CREATE TABLE [dbo].[w2_Coupon] (
...
ALTER TABLE [dbo].[w2_Coupon] WITH NOCHECK ADD
	CONSTRAINT [PK_w2_Coupon] PRIMARY KEY  CLUSTERED
	(
		[dept_id],
		[coupon_id]
	) ON [PRIMARY]
...
/*
■ ブランド・カテゴリ毎にクーポン設定
ALTER TABLE [w2_Coupon] ADD [exceptional_brand_ids] NVARCHAR(MAX) NOT NULL DEFAULT N'';
ALTER TABLE [w2_Coupon] ADD [exceptional_product_category_ids] NVARCHAR(MAX) NOT NULL DEFAULT N'';
*/