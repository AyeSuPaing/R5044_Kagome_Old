if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[w2_Staff]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[w2_Staff]
GO
/*
=========================================================================================================
  Module      : ГXГ^ГbГt (w2_Staff.sql)
 еееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееее
  Copyright   : Copyright W2 Co.,Ltd. 2019 All Rights Reserved.
=========================================================================================================
*/
CREATE TABLE [dbo].[w2_Staff] (
...
ALTER TABLE [dbo].[w2_Staff] WITH NOCHECK ADD
	CONSTRAINT [PK_w2_Staff] PRIMARY KEY  CLUSTERED
	(
		[staff_id]
	) ON [PRIMARY]
GO

CREATE INDEX [IX_w2_Staff_1] ON [dbo].[w2_Staff]([staff_height], [real_shop_id]) ON [PRIMARY]
GO
