if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[w2_ProductVariation]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[w2_ProductVariation]
GO
/*
=========================================================================================================
  Module      : 商品バリエーションマスタ(w2_ProductVariation.sql)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
  Copyright   : Copyright W2 Co.,Ltd. 2009 All Rights Reserved.
=========================================================================================================
*/
CREATE TABLE [dbo].[w2_ProductVariation] (
...
ALTER TABLE [dbo].[w2_ProductVariation] WITH NOCHECK ADD
	CONSTRAINT [PK_w2_ProductVariation] PRIMARY KEY  CLUSTERED
	(
		[shop_id],
		[product_id],
		[variation_id]
...
/*
ALTER TABLE [w2_ProductVariation] ADD [variation_andmall_reservation_flg] [nvarchar] (3) NOT NULL DEFAULT (N'001');
ALTER TABLE [w2_ProductVariation] ADD [variation_weight_gram] [int] NOT NULL DEFAULT (0);
*/
