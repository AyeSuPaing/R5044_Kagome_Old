 if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[w2_UserShipping]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[w2_UserShipping]
GO
/*
=========================================================================================================
  Module      : ユーザ配送先情報マスタ(w2_UserShipping.sql)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
  Copyright   : Copyright W2 Co.,Ltd. 2009 All Rights Reserved.
=========================================================================================================
*/
CREATE TABLE [dbo].[w2_UserShipping] (
...
ALTER TABLE [dbo].[w2_UserShipping] WITH NOCHECK ADD
	CONSTRAINT [PK_w2_UserShipping] PRIMARY KEY  CLUSTERED
	(
		[user_id],
		[shipping_no]
	) ON [PRIMARY]
