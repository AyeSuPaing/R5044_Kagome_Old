if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[w2_WorkUser]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[w2_WorkUser]
GO
/*
=========================================================================================================
  Module      : ユーザマスタ用ワークテーブル(w2_WorkUser)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
  Copyright   : Copyright W2 Co.,Ltd. 2009 All Rights Reserved.
=========================================================================================================
*/
CREATE TABLE [dbo].[w2_WorkUser] (
	...
	[name] [nvarchar] (40) NULL DEFAULT (N''),
...
ALTER TABLE [dbo].[w2_WorkUser] WITH NOCHECK ADD
	CONSTRAINT [PK_w2_WorkUser] PRIMARY KEY  CLUSTERED
	(
		[user_id]
	) ON [PRIMARY]
GO
...
CREATE INDEX [IX_w2_WorkUser_2] ON [dbo].[w2_WorkUser]([name_kana]) ON [PRIMARY]
GO

CREATE INDEX [IX_w2_WorkUser_3] ON [dbo].[w2_WorkUser]([career_id], [mobile_uid]) ON [PRIMARY]
GO

CREATE INDEX [IX_w2_WorkUser_4] ON [dbo].[w2_WorkUser]([advcode_first]) ON [PRIMARY]
GO
...
/*
-- v5.11
ALTER TABLE [w2_WorkUser] ADD [integrated_flg] [nvarchar] (1) NOT NULL DEFAULT (N'0');

EXEC w2_AlterColumnTypeSp 'w2_WorkUser', 'user_memo', 'nvarchar(MAX) NOT NULL';
ALTER TABLE [w2_WorkUser] ADD [referral_code] [nvarchar] (20) NOT NULL DEFAULT (N'');
ALTER TABLE [w2_WorkUser] ADD [referred_user_id] [nvarchar] (30) NOT NULL DEFAULT (N'');
*/