/*
=========================================================================================================
  Module      : ソニーペイメントe-SCOTTE 売上計上API(EScottProcess1CaptureApi.cs)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
namespace w2.App.Common.Order.Payment.EScott
{
	...
	/// 売上計上API
	/// </summary>
	public class EScottProcess1CaptureApi
	{
		...
		/// <returns></returns>
		public static EScottProcess1CaptureApi CreateEScottProcess1CaptureApi(string transactionId, string orderPaymentId, DateTime saleDate)
		{
			var api = new EScottProcess1CaptureApi(
				...
				EScottHelper.ToEScottDate(saleDate));
			return api;
		}
		...
		/// <param name="salesDate">売上計上日</param>
		private EScottProcess1CaptureApi(
			...
			string salesDate)
		{
			...
			m_requestParameter.AddRequestParameter(EScottConstants.OPERATE_ID, EScottConstants.OPERATOR_ID_PROCESS_1CAPTURE);
			...
			m_requestParameter.AddRequestParameter(EScottConstants.SALES_DATE, salesDate);
		}

		/// <summary>
		/// リクエスト実行
		/// </summary>
		/// <returns>売上計上APIレスポンス</returns>
		public Process1CaptureResponse ExecRequest()
		{
			var requestMessage = m_requestParameter.PostHttpRequestWithResponseSplitting();
			var result = new Process1CaptureResponse(
				requestMessage,
