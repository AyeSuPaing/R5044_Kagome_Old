/*
=========================================================================================================
  Module      : e-SCOTT プロセス金額変更レスポンス(Process1ChangeResponse.cs)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
namespace w2.App.Common.Order.Payment.EScott.DataSchema
{
	...
	/// プロセス金額変更レスポンス
	/// </summary>
	public class Process1ChangeResponse : EScottResponseBase
	{
		/// <summary>
		/// コンストラクタ
		/// </summary>
		...
		public Process1ChangeResponse(Dictionary<string, string> response, string kaiinId, string kaiinPass)
		{
			TranzactionId = response.GetValueOrEmpty(EScottConstants.TRANSACTION_ID);
			TranzactionDate = response.GetValueOrEmpty(EScottConstants.TRANSACTION_DATE);
		...
		public string TranzactionId { get; private set; }
		/// <summary>取引日付</summary>
		public string TranzactionDate { get; private set; }
