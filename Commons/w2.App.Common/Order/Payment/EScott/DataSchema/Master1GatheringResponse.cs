/*
=========================================================================================================
  Module      : e-SCOTT マスター与信と売上計上レスポンス(Master1GatheringResponse.cs)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
namespace w2.App.Common.Order.Payment.EScott.DataSchema
{
	...
	/// マスター与信と売上計上レスポンス
	/// </summary>
	public class Master1GatheringResponse : EScottResponseBase
	{
		/// <summary>
		/// コンストラクタ
		/// </summary>
		...
		public Master1GatheringResponse(Dictionary<string, string> response, string kaiinId, string kaiinPass)
		{
