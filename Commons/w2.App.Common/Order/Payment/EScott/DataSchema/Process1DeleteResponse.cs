/*
=========================================================================================================
  Module      : e-SCOTT プロセス与信削除レスポンス(Process1DeleteResponse.cs)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
namespace w2.App.Common.Order.Payment.EScott.DataSchema
{
	...
	/// プロセス与信削除レスポンス
	/// </summary>
	public class Process1DeleteResponse : EScottResponseBase
	{
		/// <summary>
		/// コンストラクタ
		/// </summary>
		/// <param name="response">レスポンス</param>
		public Process1DeleteResponse(Dictionary<string, string> response)
		{
