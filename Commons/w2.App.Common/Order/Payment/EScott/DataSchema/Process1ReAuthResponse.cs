/*
=========================================================================================================
  Module      : e-SCOTT プロセス再与信レスポンス(Process1ReAuthResponse.cs)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
namespace w2.App.Common.Order.Payment.EScott.DataSchema
{
	...
	/// プロセス再与信レスポンス
	/// </summary>
	public class Process1ReAuthResponse : EScottResponseBase
	{
		/// <summary>
		/// コンストラクタ
		/// </summary>
		...
		public Process1ReAuthResponse(Dictionary<string, string> response, string kaiinId, string kaiinPass)
		{
