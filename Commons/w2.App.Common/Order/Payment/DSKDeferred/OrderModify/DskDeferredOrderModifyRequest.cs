/*
=========================================================================================================
  Module      : DSK後払い注文情報変更リクエスト(DskDeferredOrderModifyRequest.cs)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
namespace w2.App.Common.Order.Payment.DSKDeferred.OrderModify
{
	...
	public class DskDeferredOrderModifyRequest : BaseDskDeferredRequest
	{
		/// <summary>
		/// コンストラクタ
		/// </summary>
		public DskDeferredOrderModifyRequest()
		{
