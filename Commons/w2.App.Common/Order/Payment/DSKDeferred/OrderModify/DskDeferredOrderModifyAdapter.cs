/*
=========================================================================================================
  Module      : DSK後払い注文情報変更アダプター(DskDeferredOrderModifyAdapter.cs)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
namespace w2.App.Common.Order.Payment.DSKDeferred.OrderModify
{
	...
	/// DSK後払い注文情報変更アダプター
	/// </summary>
	public class DskDeferredOrderModifyAdapter : BaseDskDeferredAdapter
	{
		/// <summary>
		/// コンストラクタ
		/// </summary>
		...
		public DskDeferredOrderModifyAdapter(OrderModel order, DskDeferredApiSetting apiSetting = null)
			: base(apiSetting)
		{
			this.Order = order;
		}
		...
		public DskDeferredOrderModifyRequest CreateRequest()
		{
			var request = new DskDeferredOrderModifyRequest();

			request.Buyer.TransactionId = this.Order.CardTranId;
		...
		public DskDeferredOrderModifyRequest Request { get; set; }
	}
}
