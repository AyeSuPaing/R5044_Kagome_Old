/*
=========================================================================================================
  Module      : Atodene取引登録リクエスト(AtodeneTransactionRequest.cs)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
namespace w2.App.Common.Order.Payment.JACCS.ATODENE.Transaction
{
	...
	public class AtodeneTransactionRequest : BaseAtodeneRequest
	{
		/// <summary>
		/// コンストラクタ
		/// </summary>
		public AtodeneTransactionRequest()
			: base()
		{
			this.BrowserInfo = new BrowserInfoElement();
			this.Customer = new CustomerElement();
			this.Ship = new ShipElement();
			this.Details = new DetailsElement();
		}

		/// <summary>ブラウザ関連情報</summary>
		[XmlElement("browserInfo")]
		public BrowserInfoElement BrowserInfo { get; set; }
		...
		/// ブラウザ関連情報要素
		/// </summary>
		public class BrowserInfoElement
		{
			/// <summary>コンストラクタ</summary>
			public BrowserInfoElement()
			{
				this.HttpHeader = "";
				this.DeviceInfo = "";
			}

			/// <summary>HTTPヘッダー情報</summary>
