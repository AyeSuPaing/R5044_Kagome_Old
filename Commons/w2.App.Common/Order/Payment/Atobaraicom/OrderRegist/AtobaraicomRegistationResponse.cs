/*
=========================================================================================================
  Module      : プリペイド登録応答 (AtobaraicomRegistationResponse.cs)
  ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
namespace w2.App.Common.Order
{
	...
	/// プリペイド登録応答
	/// </summary>
	public class AtobaraicomRegistationResponse
	{
		/// <summary>
		/// レスポンスをプロパティへ格納
		/// </summary>
			...
			foreach (var element in responseXml.Root.Elements())
			{
				switch (element.Name.ToString())
				{
					...
					case "orderStatus":
						...
						this.OrderStatusCdCode = element.Attribute("cd").Value;
						break;
		...
		public string OrderStatusCdCode { get; protected set; }
		/// <summary>Is success</summary>
		public bool IsSuccess
		{
			get
			{
				return (this.Status == AtobaraicomConstants.ATOBARAICOM_API_RESULT_STATUS_SUCCESS);
			}
		}
