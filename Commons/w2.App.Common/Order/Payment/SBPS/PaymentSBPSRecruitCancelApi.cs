/*
=========================================================================================================
  Module      : ソフトバンクペイメント マルチ決済 リクルートかんたん支払い「取消・返要求処理」APIクラス(PaymentSBPSRecruitCancelApi.cs)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
namespace w2.App.Common.Order
{
	...
	/// </summary>
	public class PaymentSBPSRecruitCancelApi : PaymentSBPSBaseApi
	{
		/// <summary>
		/// コンストラクタ
		/// </summary>
		public PaymentSBPSRecruitCancelApi()
		...
		public PaymentSBPSRecruitCancelApi(
			...
			: base(settings, new PaymentSBPSRecruitCancelResponseData(settings))
		{
		}
			...
			string trackingId)
		{
			...
			document.Add(
				new XElement("sps-api-request", new XAttribute("id", "ST02-00306-309"),
		...
		public PaymentSBPSRecruitCancelResponseData ResponseData { get { return (PaymentSBPSRecruitCancelResponseData)this.ResponseDataInner; } }
	}
}
