/*
=========================================================================================================
  Module     : SBPS ソフトバンクまとめて支払い（B）「継続課金（定期・従量）購入要求処理」APIクラス(PaymentSBPSCareerSoftbankKetaiContinuousOrderApi.cs)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
{
	/// <summary>
	/// SBPS ソフトバンクまとめて支払い（B）「継続課金（定期・従量）購入要求処理」APIクラス
	/// </summary>
	public class PaymentSBPSCareerSoftbankKetaiContinuousOrderApi : PaymentSBPSBaseApi
	{
		/// <summary>
		/// コンストラクタ
		/// </summary>
		public PaymentSBPSCareerSoftbankKetaiContinuousOrderApi()
		...
		public PaymentSBPSCareerSoftbankKetaiContinuousOrderApi(PaymentSBPSSetting settings)
			: base(settings, new PaymentSBPSCareerSoftbankKetaiContinuousOrderResponseData(settings))
		{
		}
			...
			decimal amount)
		{
			...
			document.Add(
				new XElement("sps-api-request", new XAttribute("id", "ST01-00104-405"),
		...
		public PaymentSBPSCareerSoftbankKetaiContinuousOrderResponseData ResponseData
		{
			get { return (PaymentSBPSCareerSoftbankKetaiContinuousOrderResponseData)this.ResponseDataInner; }
		}
	}
}
