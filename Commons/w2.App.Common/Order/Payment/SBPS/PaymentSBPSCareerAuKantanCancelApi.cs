/*
=========================================================================================================
  Module      : ソフトバンクペイメント AUかんたん支払い「取消・返金要求処理」APIクラス(PaymentSBPSCareerAuKantanCancelApi.cs)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
{
	/// <summary>
	/// ソフトバンクペイメント マルチ決済 AUかんたん支払い「取消・返金要求処理」APIクラス
	/// </summary>
	public class PaymentSBPSCareerAuKantanCancelApi : PaymentSBPSBaseApi
	{
		/// <summary>
		/// コンストラクタ
		/// </summary>
		public PaymentSBPSCareerAuKantanCancelApi()
		...
		public PaymentSBPSCareerAuKantanCancelApi(
			...
			: base(settings, new PaymentSBPSCareerAuKantanCancelResponseData(settings))
		{
		}
			...
			string trackingId)
		{
			...
			document.Add(
				new XElement("sps-api-request", new XAttribute("id", "ST02-00303-402"),
		...
		public PaymentSBPSCareerAuKantanCancelResponseData ResponseData { get { return (PaymentSBPSCareerAuKantanCancelResponseData)this.ResponseDataInner; } }
	}
}
