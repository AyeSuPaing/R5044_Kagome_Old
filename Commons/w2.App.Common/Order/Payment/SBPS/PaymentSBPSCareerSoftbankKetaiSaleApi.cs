/*
=========================================================================================================
  Module      : ソフトバンクペイメント ソフトバンク・ワイモバイルまとめて支払い「確定要求」APIクラス(PaymentSBPSCareerSoftbankKetaiSaleApi.cs)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
{
	/// <summary>
	/// ソフトバンクペイメント マルチ決済 ソフトバンク・ワイモバイルまとめて支払い「確定要求」APIクラス
	/// </summary>
	public class PaymentSBPSCareerSoftbankKetaiSaleApi : PaymentSBPSBaseApi
	{
		/// <summary>
		/// コンストラクタ
		/// </summary>
		public PaymentSBPSCareerSoftbankKetaiSaleApi()
		...
		public PaymentSBPSCareerSoftbankKetaiSaleApi(
			...
			: base(settings, new PaymentSBPSCareerSoftbankKetaiSaleResponseData(settings))
		{
		}
			...
			string trackingId)
		{
			...
			document.Add(
				new XElement("sps-api-request", new XAttribute("id", "ST02-00201-405"),
		...
		public PaymentSBPSCareerSoftbankKetaiSaleResponseData ResponseData { get { return (PaymentSBPSCareerSoftbankKetaiSaleResponseData)this.ResponseDataInner; } }
	}
}
