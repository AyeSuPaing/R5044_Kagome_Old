/*
=========================================================================================================
  Module      : ソフトバンクペイメント クレジット「リアル与信」APIクラス(PaymentSBPSCreditAuthApi.cs)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
{
	/// <summary>
	/// ソフトバンクペイメント クレジット「リアル与信」APIクラス
	/// </summary>
	public class PaymentSBPSCreditAuthApi : PaymentSBPSBaseApi
	{
		/// <summary>
		/// コンストラクタ
		/// </summary>
		public PaymentSBPSCreditAuthApi()
		...
		public PaymentSBPSCreditAuthApi(
			...
			: base(settings, new PaymentSBPSCreditAuthResponseData(settings))
		{
		}
		...
		/// <param name="productItems">商品情報</param>
		/// <param name="amount">注文金額合計</param>
		/// <param name="cardNo">カードNO</param>
		/// <param name="cardExpYear">カード有効期限(年2or4桁)</param>
		/// <param name="cardExpMonth">カード有効期限(月)</param>
		/// <param name="cardSecurityCode">カードセキュリティコード(指定しない場合はnull)</param>
		/// <param name="divideInfo">分割情報</param>
			...
			bool saveCardInfo)
		{
			...
			document.Add(
				new XElement("sps-api-request", new XAttribute("id", "ST01-00101-101"),
				...
				//new XElement("sps_cust_info_return_flg", this.HashCalculator.Add("0")),	// 省略時はSPS顧客情報を返却しない。
					...
					CreatePayMethodInfo(cardNo, cardExpYear, cardExpMonth, cardSecurityCode, divideInfo, saveCardInfo),
		...
		private XElement CreatePayMethodInfo(
			...
			bool saveCardInfo)
		{
			var useCardNo = (string.IsNullOrEmpty(cardNo) == false);
			...
			return new XElement("pay_method_info",
				useCardNo ? new XElement("cc_number", GetEncryptedData(this.HashCalculator.Add(cardNo))) : null,
				useCardNo ? new XElement("cc_expiration", GetEncryptedData(this.HashCalculator.Add(year + month))) : null,
				useCardNo ? new XElement("security_code", GetEncryptedData(this.HashCalculator.Add(cardSecurityCode))) : null,
				CreateDivideTypeAndTimes(divideInfo),
				new XElement("cust_manage_flg", GetEncryptedData(this.HashCalculator.Add(custManageFlg))));
		}
		...
		public PaymentSBPSCreditAuthResponseData ResponseData { get { return (PaymentSBPSCreditAuthResponseData)this.ResponseDataInner; } }
	}
}
