/*
=========================================================================================================
  Module      : ソフトバンクペイメント AUかんたん支払い「売上要求処理」APIクラス(PaymentSBPSCareerAuKantanSaleApi.cs)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
{
	/// <summary>
	/// ソフトバンクペイメント マルチ決済 AUかんたん支払い「売上要求処理」APIクラス
	/// </summary>
	public class PaymentSBPSCareerAuKantanSaleApi : PaymentSBPSBaseApi
	{
		/// <summary>
		/// コンストラクタ
		/// </summary>
		public PaymentSBPSCareerAuKantanSaleApi()
		...
		public PaymentSBPSCareerAuKantanSaleApi(
			...
			: base(settings, new PaymentSBPSCareerAuKantanSaleResponseData(settings))
		{
		}
			...
			decimal amount)
		{
			...
			document.Add(
				new XElement("sps-api-request", new XAttribute("id", "ST02-00201-402"),
		...
		public PaymentSBPSCareerAuKantanSaleResponseData ResponseData { get { return (PaymentSBPSCareerAuKantanSaleResponseData)this.ResponseDataInner; } }
	}
}
