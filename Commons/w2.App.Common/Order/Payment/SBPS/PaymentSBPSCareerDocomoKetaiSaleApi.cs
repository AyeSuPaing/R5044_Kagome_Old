/*
=========================================================================================================
  Module      : ソフトバンクペイメント ドコモケータイ払い「売上要求処理」APIクラス(PaymentSBPSCareerDocomoKetaiSaleApi.cs)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
{
	/// <summary>
	/// ソフトバンクペイメント マルチ決済 ドコモケータイ払い「売上要求処理」APIクラス
	/// </summary>
	public class PaymentSBPSCareerDocomoKetaiSaleApi : PaymentSBPSBaseApi
	{
		/// <summary>
		/// コンストラクタ
		/// </summary>
		public PaymentSBPSCareerDocomoKetaiSaleApi()
		...
		public PaymentSBPSCareerDocomoKetaiSaleApi(
			...
			: base(settings, new PaymentSBPSCareerDocomoKetaiSaleResponseData(settings))
		{
		}
			...
			decimal amount)
		{
			...
			document.Add(
				new XElement("sps-api-request", new XAttribute("id", "ST02-00201-401"),
		...
		public PaymentSBPSCareerDocomoKetaiSaleResponseData ResponseData { get { return (PaymentSBPSCareerDocomoKetaiSaleResponseData)this.ResponseDataInner; } }
	}
}
