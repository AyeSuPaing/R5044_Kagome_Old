/*
=========================================================================================================
  Module      : Paygent API Paidy売上電文 結果モデル(PaidySettlementResponseDataset.cs)
  ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
{
	/// <summary>
	/// Paygent API Paidy売上電文 結果モデル
	/// </summary>
	[Serializable]
	public class PaidySettlementResponseDataset : IPaygentResponse
	{
