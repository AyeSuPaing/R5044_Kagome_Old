/*
=========================================================================================================
  Module      : Paygent API Paidy売上電文 リクエストボディ(PaidySettlementPostBody.cs)
  ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
{
	/// <summary>
	/// Paygent API Paidy売上電文 リクエストボディ
	/// </summary>
	[Serializable]
	public class PaidySettlementPostBody
	{
		/// <summary>
		/// コンストラクタ
		/// </summary>
		/// <param name="paymentId">決済ID(ペイジェントが割り当てたもの)</param>
		/// <remarks>paymentId・trandingIdのどちらか一方は指定必須</remarks>
		public PaidySettlementPostBody(
			string paymentId)
		{
			...
			this.TelegramKind = PaygentConstants.PAYGENT_TELEGRAM_KIND_PAIDY_SETTLEMENT;
