/*
=========================================================================================================
  Module      : Paygent API Paidy決済情報検証電文 リクエストボディ(PaidyAuthorizationPostBody.cs)
  ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
{
	/// <summary>
	/// Paygent API Paidy決済情報検証電文 リクエストボディ
	/// </summary>
	[Serializable]
	public class PaidyAuthorizationPostBody
	{
		/// <summary>
		/// コンストラクタ
		/// </summary>
		/// <param name="paymentId">決済ID(Paidy)</param>
		public PaidyAuthorizationPostBody(string paymentId)
		{
			...
			this.TelegramKind = PaygentConstants.PAYGENT_TELEGRAM_KIND_PAIDY_AUTHORIZATION;
		...
		public Dictionary<string, string> GenerateKeyValues()
		{
			var parameters = new Dictionary<string, string>
			{
				...
				{ PaygentConstants.PAYGENT_API_REQUEST_PAIDY_PAYMENT_ID, this.PaymentId },
			};
			return parameters;
		}
