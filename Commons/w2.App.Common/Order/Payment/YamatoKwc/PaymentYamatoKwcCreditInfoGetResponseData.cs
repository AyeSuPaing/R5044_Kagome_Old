/*
=========================================================================================================
  Module      : ヤマトKWC クレジット情報取得APIレスポンスデータ(PaymentYamatoKwcCreditInfoGetApi.cs)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
{
	/// <summary>
	/// ヤマトKWC クレジット情報取得APIレスポンスデータ
	/// </summary>
	public class PaymentYamatoKwcCreditInfoGetResponseData : PaymentYamatoKwcResponseDataBase
	{
		/// <summary>
		/// コンストラクタ
		/// </summary>
		/// <param name="responseString">レスポンス文字列</param>
		public PaymentYamatoKwcCreditInfoGetResponseData(string responseString)
			: base(responseString)
		{
		}
