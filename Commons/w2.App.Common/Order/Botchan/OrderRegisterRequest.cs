/*
=========================================================================================================
  Module      : Order Register Request(OrderRegisterRequest.cs)
  ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
namespace w2.App.Common.Order.Botchan
{
	...
	public class OrderRegisterRequest
	{
		...
		public class Cart
		{
			...
			[JsonProperty("after_order_recommend_flag")]
			public string AfterOrderRecommendFlag { get; set; }
			/// <summary>元注文ID</summary>
			[JsonProperty("old_order_id")]
