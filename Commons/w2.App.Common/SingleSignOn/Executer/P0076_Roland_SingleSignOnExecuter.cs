/*
=========================================================================================================
  Module      : シングルサインオン実行（P0076_Roland用）クラス(P0076_Roland_SingleSignOnExecuter.cs)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
{
	/// <summary>
	/// シングルサインオン実行（P0076_Roland用）クラス
	/// </summary>
	public class P0076_Roland_SingleSignOnExecuter : BaseSingleSignOnExecuter
	{
		#region 定数
		/// <summary>mID（RolandFCサイト会員ID）</summary>
		private const string FIELD_USEREXTEND_USEREX_MID = "usrex_mid";
		/// <summary>RolandFCサイト用会員ランクID</summary>
		private const string ROLAND_MEMBER_RANK_ID = "FCmember";
		#endregion
		...
		public P0076_Roland_SingleSignOnExecuter(HttpContext context)
			: base(context)
		{
		}
		#endregion
		...
		protected override SingleSignOnResult OnExecute()
		{
			...
			// 会員ランク存在チェック
			var memberRankName = MemberRankOptionUtility.GetMemberRankName(ROLAND_MEMBER_RANK_ID);
			...
			if (hasUserExtend)
			{
				using (var accessor = new SqlAccessor())
				{
					...
					userService.Modify(
						user.UserId,
						userModel => { userModel.MemberRankId = ROLAND_MEMBER_RANK_ID; },
		...
		private UserModel CreateUser(CallBackParameters parameters)
		{
			...
			var user = new UserModel
			{
				...
				MemberRankId = ROLAND_MEMBER_RANK_ID,
		...
		#region RolandFCサイト コールバックパラメータクラス
		/// <summary>
		/// RolandFCサイト コールバックパラメータクラス
		/// </summary>
