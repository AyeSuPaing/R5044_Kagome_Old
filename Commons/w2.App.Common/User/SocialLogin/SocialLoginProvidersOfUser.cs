/*
=========================================================================================================
  Module      : ソーシャルログインWebAPI ユーザがログインしたことのあるプロバイダ一覧取得(SocialLoginProvidersOfUser.cs)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
{
	/// <summary>
	/// ユーザがログインしたことのあるプロバイダ一覧取得
	/// </summary>
	public class SocialLoginProvidersOfUser : SocialLoginBase
	{
		/// <summary>
		/// コンストラクタ
		/// </summary>
		public SocialLoginProvidersOfUser()
			: base(SocialLoginApiFunctionType.ProvidersOfUser)
		{
		}
