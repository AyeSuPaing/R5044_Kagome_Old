/*
=========================================================================================================
  Module      : ソーシャルログインWebAPI ソーシャルプラスIDとw2のユーザID紐づけ解除(SocialLoginUnMap.cs)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
{
	/// <summary>
	/// ソーシャルプラスIDとw2のユーザID紐づけ解除
	/// </summary>
	public class SocialLoginUnMap : SocialLoginBase
	{
		/// <summary>
		/// コンストラクタ
		/// </summary>
		public SocialLoginUnMap()
			: base(SocialLoginApiFunctionType.Unmap)
		{
		}
