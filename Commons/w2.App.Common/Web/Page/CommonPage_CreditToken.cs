/*
=========================================================================================================
  Module      : コモンページ ※トークン処理(CommonPage_CreditToken.cs)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
namespace w2.App.Common.Web.Page
{
	...
	public partial class CommonPage
	{
		...
		/// <summary>
		/// クレジットカードトークン向け カスタムバリデータを通す (UserCreditInput用)
		/// </summary>
		/// <param name="riParent">親カートリピータアイテム(カート外であればnullを指定)</param>
		protected void EnableCreditInputCustomValidatorForGetCreditToken(RepeaterItem riParent = null)
		{
			this.Process.EnableCreditInputCustomValidatorForGetCreditToken(riParent);
		}
