...
set WORK_DIR=C:\_w2cManager\Logs\ExternalAPI\Orderstatus\
...
set FTP_DOWNLOAD_SOURCE=/order/export/%SHOP_CODE%/orderstatus/
...
%CURRENT_DIR%ExternalAPI.exe -setArgs -apiID:TempoStar_ImportOrderStatus -target:%WORK_DIR%\NO_FILE -apiType:import -fileType:csv -useftpdownload:true -props:%FTP_ARGS%