...
{
	public class ApiExportCommandBuilder_Pxxxx_Sample_E_0006 : ApiExportCommandBuilder
	{
		public override DataTable GetDataTable()
		{
			...
			// パラメータ設定（開始時間のみ指定）
			stockQuantitiesFromArg.TimeSpan = new PastAbsoluteTimeSpan(-5, DateTime.Parse("2012-02-16 16:17:49.053"));
