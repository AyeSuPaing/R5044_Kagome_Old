...
{
	/// <summary>
	/// 35分前から5分前までの在庫の増減数を取得する（30分間を対象）汎用コマンドビルダ
	/// </summary>
    public class ApiExportCommandBuilder_SimpleCommandLibrary_E_0003 : ApiExportCommandBuilder
   {
	   public override DataTable GetDataTable()
	   {
		   ...
		   // パラメータ設定（開始時間のみ指定）
		   stockQuantitiesFromArg.TimeSpan = new PastAbsoluteTimeSpan(-5, DateTime.Now.AddMinutes(-35));
