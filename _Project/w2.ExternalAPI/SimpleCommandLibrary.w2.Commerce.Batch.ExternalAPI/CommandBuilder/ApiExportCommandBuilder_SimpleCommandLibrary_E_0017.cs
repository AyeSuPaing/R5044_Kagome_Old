...
{
	/// <summary>
	/// 注文ID及びステータスの指定は無しで、5分前から10分前の間に作成された注文配送先情報を取得する汎用コマンドビルダ
	/// </summary>
    public class ApiExportCommandBuilder_SimpleCommandLibrary_E_0017 : ApiExportCommandBuilder
   {
	   #region #Export 出力処理
	   ...
	   public override DataTable GetDataTable()
	   {
		   ...
		   GetOrderShippingsArg arg = new GetOrderShippingsArg
		   {
			   ...
			   CreatedTimeSpan = new PastAbsoluteTimeSpan(-5, DateTime.Now.AddMinutes(-5)),
			   // 注文ステータス
			   OrderStatus = "",
