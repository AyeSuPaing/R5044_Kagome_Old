...
{
	/// <summary>
	/// 注文ID及びステータスの指定は無しで、5分前から35分前の間に更新された注文配送先情報を取得する汎用コマンドビルダ
	/// </summary>
    public class ApiExportCommandBuilder_SimpleCommandLibrary_E_0022 : ApiExportCommandBuilder
   {
	   #region #Export 出力処理
	   ...
	   public override DataTable GetDataTable()
	   {
		   ...
		   GetOrderShippingsArg arg = new GetOrderShippingsArg
		   {
			   ...
			   UpdatedTimeSpan = new PastAbsoluteTimeSpan(-5, DateTime.Now.AddMinutes(-35)),
			   // 注文ステータス
			   OrderStatus = "",
