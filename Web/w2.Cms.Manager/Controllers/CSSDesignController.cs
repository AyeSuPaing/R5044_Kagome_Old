/*
=========================================================================================================
  Module      : コンテンツマネージャコントローラ(CSSDesignController.cs)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
namespace w2.Cms.Manager.Controllers
{
	...
	/// コンテンツマネージャコントローラ
	/// </summary>
	public class CSSDesignController : BaseController
	{
		/// <summary>
		/// インデックス
		/// </summary>
		/// <returns>結果</returns>
		public ActionResult CssDesign()
		{
		...
		public ActionResult MakeDirectory()
		{
			var objList = new List<object>
			{
				...
				this.SessionWrapper.CssDesignMnagerClickCurrent
			};
		...
		/// <returns>エラーページか作成後ディレクトリのパス</returns>
		[HttpPost]
		public ActionResult CreateCssFile(bool isNew)
		{
			var objList = new List<object>
			{
		...
		[HttpPost]
		public ActionResult GetCssText()
		{
		...
		[HttpPost]
		public ActionResult UpdateCss(string text)
		{
		...
		private CSSDesignWorkerService Service { get { return GetDefaultService<CSSDesignWorkerService>(); } }
	}
}
