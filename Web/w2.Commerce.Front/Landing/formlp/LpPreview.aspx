...
=========================================================================================================
--%>
<%@ Page Language="C#" MasterPageFile="~/Landing/formlp/formlp.master" AutoEventWireup="true" CodeFile="~/Landing/formlp/LpPreview.aspx.cs" Inherits="Landing_formlp_LpPreview" Title="ランディングカートテンプレート画面" %>
...
<script runat="server">
	...
	{
		get { return "lp_page_design_model_pc"; }
	}
</script>
<%-- △△Amazonペイメントを使う場合はウィジェットを配置するページは必ずSSLでなければいけない△△ --%>
