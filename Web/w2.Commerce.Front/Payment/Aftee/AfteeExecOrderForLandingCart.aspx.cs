/*
=========================================================================================================
  Module      : Aftee LPカート用与信取得ページ(AfteeExecOrderForLandingCart.aspx.cs)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
public partial class Payment_Aftee_AfteeExecOrderForLandingCart : OrderCartPageLanding
{
	/// <summary>
	/// ページロード
	/// </summary>
	...
	{
		ucAfteePaymentScript.CurrentUrl = Constants.PATH_ROOT + Constants.PAGE_FRONT_LANDING_LANDING_CART_CONFIRM;
		if (!IsPostBack)
		{
			hfAfteeToken.Value = this.IsLoggedIn
