<%--
=========================================================================================================
  Module      : Aftee LPカート用与信取得ページ(AfteeExecOrderForLandingCart.aspx)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
  Copyright   : Copyright w2solution Co.,Ltd. 2023 All Rights Reserved.
=========================================================================================================
--%>
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AfteeExecOrderForLandingCart.aspx.cs" Inherits="Payment_Aftee_AfteeExecOrderForLandingCart" %>
	...
	<body>
		<form id="form1" onsubmit="return (document.getElementById('__EVENTVALIDATION') != null);" runat="server">
			...
			<script type="text/javascript">
				...
				let isMyPage = null;
				$('#<%= hfAfteeToken.ClientID %>').val('<%= this.IsLoggedIn 
				...
				function SetAfteeTokenFromChildPage(token) {
					$('#<%= hfAfteeToken.ClientID %>').val(token);
				}

				// 現在のトークンを取得
				function GetCurrentAfteeToken() {
					return $('#<%= hfAfteeToken.ClientID %>').val();
				}

				// Aftee決済を利用するカートのIndexを取得
