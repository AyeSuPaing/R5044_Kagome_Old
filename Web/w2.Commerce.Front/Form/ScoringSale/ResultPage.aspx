...
<head id="Head1" runat="server">
	...
	<script type="text/javascript" charset="UTF-8" src="<%= Constants.PATH_ROOT %>Js/scoringsale_js.js"></script>
	<script type="text/javascript" charset="UTF-8" src="<%= Constants.PATH_ROOT %>Js/Slick/slick.min.js"></script>
								...
								<div class="scoringsale_product">
									<div class="scoringsale_product_flex">
										...
										<div class="scoringsale_product_info">
											...
											<asp:HiddenField id="suggestedMin" runat="server"  />
											<asp:HiddenField id="suggestedMax" runat="server" />
										</div>
									</div>
								</div>
								<div class="scoringsale_htmlcontent">
