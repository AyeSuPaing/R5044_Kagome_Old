...
=========================================================================================================
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="QuestionPullDown.ascx.cs" Inherits="Form_Common_ScoringSale_QuestionPullDown" %>
<div>
	<h2 class="scoringsale_ttl"><%# ReplaceTag("@@ScoringSaleQuestion.question_symbol_text.name@@") %><%#: (this.Question != null) ? this.Question.Question.QuestionNo : 0 %></h2>
