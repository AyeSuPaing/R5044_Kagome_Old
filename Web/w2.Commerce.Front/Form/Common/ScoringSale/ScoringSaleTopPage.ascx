...
=========================================================================================================
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ScoringSaleTopPage.ascx.cs" Inherits="Form_Common_ScoringSale_ScoringSaleTopPage" %>
...
<div class="scoringsale_item">
	...
	<div class="scoringsale_img">
		<img src="<%: this.TopPageImgPath %>" style="height: 298px;"/>
	</div>
