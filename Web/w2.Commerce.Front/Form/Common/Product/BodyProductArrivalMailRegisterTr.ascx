<%--
=========================================================================================================
  Module      : 入荷通知メール登録（テーブル）ユーザコントロール(BodyProductArrivalMailRegister.ascx)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
<table>
	...
	<tr visible="<%# (this.IsLoggedIn && this.HasPcAddr) %>" runat="server">
		<td>
			<asp:CheckBox id="cbUserPcAddr" runat="server" Checked="<%# (this.IsPcAddrRegistered || this.HasPcAddr) %>" Text='<%#: string.Format("{0} ({1})", ReplaceTag("@@User.mail_addr.name@@"), this.PcAddr) %>' />
		</td>
	</tr>
	<tr visible="<%# (Constants.MOBILEOPTION_ENABLED && this.IsLoggedIn && this.HasMbAddr) %>" runat="server">
		<td>
			<asp:CheckBox id="cbUserMobileAddr" runat="server" Checked="<%# (Constants.MOBILEOPTION_ENABLED && (this.IsMbAddrRegistered || (this.HasPcAddr == false))) %>" Text='<%#: string.Format("{0} ({1})", ReplaceTag("@@User.mail_addr2.name@@"), this.PcAddr) %>' />
		</td>
	</tr>
	<tr>
		<td>
