<%--
=========================================================================================================
  Module      : 特集ページ一覧出力コントローラ(BodyFeaturePageList.ascx)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
<asp:Repeater ID="rFeaturePageList" ItemType="w2.Domain.FeaturePage.FeaturePageModel" runat="server">
					...
					<ul>
						<li class="feature-page-parts-thumb">
							<a href='<%# WebSanitizer.UrlAttrHtmlEncode(Item.FeaturePagePath) %>'>
								<img src="<%# WebSanitizer.UrlAttrHtmlEncode(Item.PcBannerImageSrc) %>" />
							</a>
						</li>
	...
	<FooterTemplate>
			...
			<div class="feature-page-parts-viewmore"><a class="btn btn-mid btn-inverse" href="<%: this.ViewMoreUrl %>">もっと見る</a></div>
		</div>
	</FooterTemplate>
</asp:Repeater>
<%-- △編集可能領域△ --%>