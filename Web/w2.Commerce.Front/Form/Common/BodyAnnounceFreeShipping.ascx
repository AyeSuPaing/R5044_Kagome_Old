...
--%>
<%-- ▽編集可能領域：コンテンツ▽ --%>
<div class="dvAnnounceFreeShipping">
	<span runat="server" visible="<%# this.DifferenceFreeShippingPrice != 0 %>">あと<span class="defPrice"><%#: CurrencyManager.ToPrice(this.DifferenceFreeShippingPrice) %></span>以上ご購入されますと<span class="defPrice freeShipping">送料無料</span>となります。<br /></span>
