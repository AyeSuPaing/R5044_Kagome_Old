...
<%-- ▽ユーザーコントロール宣言領域▽ --%>
<%-- △ユーザーコントロール宣言領域△ --%>
<%@ Page Title="送料について" Language="C#" Inherits="ContentsPage" MasterPageFile="~/SmartPhone/Form/Common/DefaultPage.master" %>
<%--
...
<div class="unit">
	...
	また、「定期配送サービス」は送料無料でお届けいたします。さらに、「定期配送サービス」をご注文いただき、その定期商品と同時発送の場合に限り、「定期配送サービス」以外の商品も送料無料となります。
</div>
<div class="unit">
	<h4>【お届けできる地域】</h4>
	日本国外および離島等、一部の地域への配送はお受けできない場合がございます。予めご了承ください。<br />
	商品が欠品等の場合、その旨を表示する場合がございますので予めご了承ください。その他の販売条件について画面上表記する場合がございます。
</div>
<div class="unit">
	<h4>【お届けまでの期間】</h4>
