<%--
=========================================================================================================
  Module      : スマートフォン用特集ページ一覧画面(FeaturePageList.aspx)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
<%-- ▽ユーザーコントロール宣言領域▽ --%>
<%-- △ユーザーコントロール宣言領域△ --%>
<%@ Page Language="C#" MasterPageFile="~/SmartPhone/Form/Common/DefaultPage.master" AutoEventWireup="true" CodeFile="~/Form/FeaturePage/FeaturePageList.aspx.cs" Inherits="Form_FeaturePage_FeaturePageList" Title="特集ページ一覧ページ" %>
<%@ Register TagPrefix="uc" TagName="BodyFeaturePageCategoryLinks" Src="~/SmartPhone/Form/Common/FeaturePage/BodyFeaturePageCategoryLinks.ascx" %>
<%@ Register TagPrefix="uc" TagName="BodyFeaturePageCategoryBreadcrumbs" Src="~/SmartPhone/Form/Common/FeaturePage/BodyFeaturePageCategoryBreadcrumbs.ascx" %>
...
<div visible="<%# (this.FeaturePageList.Length == 0) %>" runat="server" class="msg-alert">
