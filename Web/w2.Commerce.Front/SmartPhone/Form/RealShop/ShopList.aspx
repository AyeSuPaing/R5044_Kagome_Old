...
<%-- ▽ユーザーコントロール宣言領域▽ --%>
<%-- △ユーザーコントロール宣言領域△ --%>
<%@  Page Language="C#" MasterPageFile="~/SmartPhone/Form/Common/DefaultPage.master" AutoEventWireup="true" CodeFile="~/Form/RealShop/ShopList.aspx.cs" Inherits="Form_RealShop_ShopList" Title="店舗一覧" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
	...
	<%-- ▽編集可能領域：コンテンツ▽ --%>
	<div id="dvRealShopContents" class="shopdetail-unit">
		<h2>店舗一覧</h2>
		<div class="tags">
			<ul class="areaTags">
