<%--
=========================================================================================================
  Module      : スマートフォン用トップ・コーディネートリスト出力コントローラ(BodyCoordinateListForTop.ascx)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
<asp:Repeater ID="rCoordinateList" runat="server">
	...
	<FooterTemplate>
		...
		<div class="view-more">
			<a href="<%= Constants.PATH_ROOT %>Form/Coordinate/CoordinateTop.aspx" class="btn">コーディネートをもっと見る</a>
		</div>
	</div>
</section>
	<% } %>
