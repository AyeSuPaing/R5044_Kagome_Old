<%--
=========================================================================================================
  Module      : LPプレビューページ(LpPreview.aspx)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
  Copyright   : Copyright W2 Co.,Ltd. 2019 All Rights Reserved.
=========================================================================================================
--%>
<%@ Page Language="C#" MasterPageFile="~/SmartPhone/Landing/formlp/formlp.master" AutoEventWireup="true" CodeFile="~/Landing/formlp/LpPreview.aspx.cs" Inherits="Landing_formlp_LpPreview" Title="ランディングカートテンプレート画面" %>
...
<script runat="server">
	...
	protected override string LpModelSessionKey
	{
		get { return "lp_page_design_model_sp"; }
	}
</script>
<%-- △△Amazonペイメントを使う場合はウィジェットを配置するページは必ずSSLでなければいけない△△ --%>
...
<script type="text/C#" runat="server">
	...
	{
		this.m_addProductError.Add(errorMsg);
	}
</script>
...
<link href="<%: Constants.PATH_ROOT %>SmartPhone/Css/user.css" rel="stylesheet" type="text/css" media="all" />
	...
	<%--▼▼ カート追加NG商品メッセージ ▼▼--%>
	<% if(this.m_addProductError.Count > 0) { %>
		<div>
		...
		<div>
			<span style="color: red; font-size: 20pt;">
				<%: string.Join("<br/>", this.m_addProductError) %>
			</span>
		</div>
	<% } %>
	<%--▲▲ カート追加NG商品メッセージ ▲▲--%>
