/*
=========================================================================================================
  Module      : 公開範囲設定 特集ページ管理クラス (ReleaseRangeFeaturePage.cs)
  ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
/// 公開範囲設定 特集ページ管理クラス
/// </summary>
public class ReleaseRangeFeaturePage : ReleaseRangeBase
{
	/// <summary>
	/// コンストラクタ
	/// </summary>
	/// <param name="model">特集ページ管理モデル</param>
	public ReleaseRangeFeaturePage(FeaturePageModel model)
	{
	...
	/// </summary>
	/// <param name="model">特集ページ管理モデル</param>
	private void SetCondition(FeaturePageModel model)
	{
