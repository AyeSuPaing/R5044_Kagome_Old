/*
=========================================================================================================
  Module      : 注文カート系画面入力基底ページ(OrderCartPage_OrderShipping_Fp.cs)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
/// <summary>
/// OrderCartPage_OrderShipping_fp の概要の説明です
/// </summary>
public partial class OrderCartPage : OrderPageDisp
{
	...
	/// （TRUE：月間隔・週・曜日指定パターン；FALSE：月間隔日付指定パターン）
	/// <param name="isKbn2">区分2か</param>
	...
	/// <summary>
	/// First shipping date dropdown list item selected
	/// </summary>
	/// <param name="sender"></param>
	/// <param name="e"></param>
