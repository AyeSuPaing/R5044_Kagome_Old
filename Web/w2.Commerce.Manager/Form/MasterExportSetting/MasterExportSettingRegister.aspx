												...
												<table cellspacing="1" cellpadding="2" width="758" border="0">
													<tr>
														...
														<td class="search_item_bg" colspan="5">
															<asp:RadioButtonList id="rblMasterKbn" runat="server" RepeatDirection="Horizontal" RepeatLayout="Table" cssclass="chkBoxList" Width="653" AutoPostBack="True" RepeatColumns="4" OnSelectedIndexChanged="rblMasterKbn_SelectedIndexChanged1"></asp:RadioButtonList></td>
													</tr>
												</table>
											</td>
										</tr>
										...
										<tr>
											...
											<td>
												...
												<div class="action_part_top">
													...
													<asp:Button id="btnDeleteTop" runat="server" Visible="False" Text="  削除する  " OnClick="btnDeleteTop_Click" OnClientClick= "return confirm('情報を削除してもよろしいですか？');" CssClass="cmn-btn-sub-action" />
													<asp:Button id="btnUpdateTop" runat="server" Visible="False" Text="  更新する  " OnClick="btnUpdateTop_Click" CssClass="cmn-btn-sub-action"/>
												</div>
												<hr />
												<div class="action_part_top">
													<asp:TextBox id="tbSettingName" align="left" Width="275px" runat="server"></asp:TextBox>
													<asp:Button id="btnRegisterTop" runat= "server" Visible="False" Text="  新規登録  " OnClick="btnRegisterTop_Click" CssClass="cmn-btn-sub-action" />
												</div>
															...
															<table class="edit_table" cellspacing="0" cellpadding="0" border="0" width="360">
																<tr>
																	<td class="edit_item_bg" align="right">
																		<input type="button" value="  全ての項目を一括選択  " onclick="javascript:set_field_all();" class="cmn-btn-sub-action" />
																	</td>
																</tr>
															</table>
