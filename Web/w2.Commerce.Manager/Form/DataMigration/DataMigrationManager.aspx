...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderBody" Runat="Server">
	<table cellspacing="0" cellpadding="0" width="791" border="0">
		...
		<tr>
			<td>
				<h2 class="cmn-hed-h2"><%: ReplaceTag("@@DispText.data_migration_manager.credit_execution.header@@") %></h2>
			</td>
		</tr>
		<tr>
			<td>
				<div class="action_part_top">
					<table class="info_table" cellspacing="1" cellpadding="3" width="758" border="0">
						<tr class="info_item_bg">
							<td align="left">
								<%= this.MessageNotesCreditExecution %>
							</td>
						</tr>
					</table>
				</div>
		...
		<tr>
			<td>
				<table class="box_border" cellspacing="1" cellpadding="3" width="784" border="0">
					<tr>
						<td class="info_box_bg">
							<table class="edit_table" cellspacing="1" cellpadding="2" width="758" border="0">
								<tr>
									<td class="edit_title_bg" width="100">
										<img alt="" class="search_title_arrow" src="../../Images/Common/arrow_01.gif" />
										<%: ReplaceTag("@@DispText.data_migration_manager.credit_execution.text@@") %>
										<span class="notice">*</span>
									</td>
									<td class="edit_item_bg" colspan="4">
										<asp:RadioButtonList
											ID="rblAuthorizeMode"
											OnSelectedIndexChanged="rblAuthorizeMode_SelectedIndexChanged"
											Runat="server"
								...
								<tr>
									<td class="edit_title_bg" width="60">
										<img alt="" class="search_title_arrow" src="../../Images/Common/arrow_01.gif" />
										<%: ReplaceTag("@@DispText.data_migration_manager.credit_execution.date@@") %>
									</td>
									<td class="edit_item_bg" width="125">
										<uc:DateTimePickerPeriodInput id="ucCreditExecutionDate" CanShowEndDatePicker="False" IsNullStartDateTime="True" IsHideTime="True" runat="server" />
									</td>
									<td class="edit_title_bg" width="100">
										<img alt="" class="search_title_arrow" src="../../Images/Common/arrow_01.gif" />
										<%: ReplaceTag("@@DispText.data_migration_manager.credit_execution.extended_status@@") %>
									</td>
									<td class="edit_item_bg">
										<asp:DropDownList ID="ddlExtendedStatus" DataTextField="Text" DataValueField="Value" AutoPostBack="true" runat="server" />
									</td>
								</tr>
							</table>
						</td>
						...
						<td>
							<div id="divComp" runat="server" Visible="False">
								<table class="info_table" cellspacing="1" cellpadding="3" width="100%" border="0">
									<tr class="info_item_bg">
										<td align="left">
											<%= WebMessages.GetMessages(WebMessages.ERRMSG_DATA_CREDIT_COMPLETE_MESSAGE) %>
										</td>
									</tr>
								</table>
							</div>
					...
					<tr>
						<td>
							<div class="action_part_bottom">
								<asp:Button ID="btnAuthExecute" Runat="server" OnClick="btnAuthExecute_Click" />
							</div>
						</td>
					</tr>
				</table>
	...
	<script type="text/javascript">
		$(document).ready(function () {
			$('.btn-modal-open-custom').on('click', function () {
				$('#<%= divComp.ClientID %>').hide();
				$('#<%= btnAuthExecute.ClientID %>').removeAttr('disabled');
			});
