...
<%
	rbExecBySchedule.Attributes.Add("OnClick", "RefleshScenarioSchedule();");
	rbExecByManual.Attributes.Add("OnClick", "RefleshScenarioSchedule();");
	rbScheRepeatDay.Attributes.Add("OnClick", "RefleshScenarioSchedule();");
	rbScheRepeatWeek.Attributes.Add("OnClick", "RefleshScenarioSchedule();");
	rbScheRepeatMonth.Attributes.Add("OnClick", "RefleshScenarioSchedule();");
	rbScheRepeatOnce.Attributes.Add("OnClick", "RefleshScenarioSchedule();");
%>
<table class="detail_table" width="758" border="0" cellspacing="1" cellpadding="3">
	<tr>
		<td class="edit_title_bg" height="20">実行タイミング<span class="notice">*</span></td>
	</tr>
	<tr>
...
<script type="text/javascript">
	RefleshScenarioSchedule();
	function RefleshScenarioSchedule() {
		// 詳細スケジュール設定？
