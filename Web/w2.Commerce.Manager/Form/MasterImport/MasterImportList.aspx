...
=========================================================================================================
--%>
<%@ Page Language="C#" MasterPageFile="~/Form/Common/DefaultPage.master" AutoEventWireup="true" CodeFile="MasterImportList.aspx.cs" Inherits="Form_MasterUpload_MasterUploadInput" %>
													...
													<tr class="info_item_bg">
														<td align="left">
															...
															<% if (Constants.PAYMENT_GMO_POST_ENABLED){ %>
																<p style="color:red">
																	GMO掛け払い枠保証情報はユーザーマスタでアップロードすることはできません。
																</p>
															<% } %>
														</td>
													</tr>
