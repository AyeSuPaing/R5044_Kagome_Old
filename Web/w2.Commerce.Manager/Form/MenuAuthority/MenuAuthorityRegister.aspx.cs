/*
=========================================================================================================
  Module      : メニュー権限情報登録ページ処理(MenuAuthorityRegister.aspx.cs)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
public partial class Form_MenuAuthority_MenuAuthorityRegister : BasePage
{
	...
	private void DisplayForInit()
	{
		...
		// データバインド
		var menus = this.LoginOperatorMenu;
		// Remove storepickup order list option if real shop option is off
		if (Constants.REALSHOP_OPTION_ENABLED == false)
		{
			menus = menus.Where(m => m.Key != "storepickup").ToList();
		}
		rLargeMenu.DataSource = menus;
		rLargeMenu.DataBind();
	}
