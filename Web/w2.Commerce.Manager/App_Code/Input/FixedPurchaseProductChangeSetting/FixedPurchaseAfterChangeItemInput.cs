/*
=========================================================================================================
  Module      : 定期変更後商品入力クラス (FixedPurchaseAfterChangeItemInput.cs)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
/// </summary>
[Serializable]
public class FixedPurchaseAfterChangeItemInput : InputBase<FixedPurchaseAfterChangeItemModel>
{
	#region コンストラクタ
	/// <summary>
	/// デフォルトコンストラクタ
	/// </summary>
	public FixedPurchaseAfterChangeItemInput()
	{
	}
	/// <summary>
	/// コンストラクタ
	...
	public FixedPurchaseAfterChangeItemInput(FixedPurchaseAfterChangeItemContainer model)
	{
	...
	/// モデル作成
	/// </summary>
	/// <returns>定期変更後商品モデル</returns>
	public override FixedPurchaseAfterChangeItemModel CreateModel()
	{
		return new FixedPurchaseAfterChangeItemModel
		{
