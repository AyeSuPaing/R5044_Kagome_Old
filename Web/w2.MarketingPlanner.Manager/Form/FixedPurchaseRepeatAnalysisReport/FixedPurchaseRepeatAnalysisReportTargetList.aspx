<%-- 
=========================================================================================================
  Module      : Fixed Purchase Repeat Analysis Report Target List (FixedPurchaseRepeatAnalysisReportTargetList.aspx)
  ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
  Copyright   : Copyright W2 Co.,Ltd. 2023 All Rights Reserved.
=========================================================================================================
--%>

<%@ Page Title="" Language="C#" MasterPageFile="~/Form/Common/PopupPage.master" AutoEventWireup="true" CodeFile="FixedPurchaseRepeatAnalysisReportTargetList.aspx.cs" Inherits="Form_FixedPurchaseRepeatAnalysisReport_FixedPurchaseRepeatAnalysisReportTargetList" %>
			...
			<td>
				<table class="box_border" cellspacing="1" cellpadding="3" width="634" border="0">
					<tbody>
						<tr>
							<td>
								<table class="info_box_bg" cellspacing="0" cellpadding="0" width="100%" border="0" id="pnRegister" runat="server" visible="true">
									<tbody>
										<tr>
											<td align="center">
														...
														<tr>
															<td>
																	...
																	<tbody>
																		<tr>
																			...
																			<td align="left" class="search_item_bg">
																				<asp:TextBox ID="tbTargetListName" MaxLength="30" Width="300" runat="server" />
																			</td>
																		</tr>
																	</tbody>
																</table>
																...
																<table class="detail_table" width="608" border="0" cellspacing="1" cellpadding="3">
																	<tbody>
																		<tr>
																			<td align="left" class="search_title_bg" width="130">抽出元</td>
																			<td align="left" class="search_item_bg">
																				<asp:Label ID="lbSourceName" runat="server" />
																			</td>
																		</tr>
																		<tr>
																			<td align="left" class="search_title_bg">件数</td>
																			<td align="left" class="search_item_bg">
																				<asp:Label ID="lbDataCount" runat="server" />
																			</td>
																		</tr>
																	</tbody>
																</table>
																<div class="action_part_bottom">
																	<p>ターゲットリスト名が30文字を超える場合、31文字目以降は省略されます。</p>
																</div>
															</td>
														</tr>
													</tbody>
