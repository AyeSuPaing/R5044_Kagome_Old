<%--
=========================================================================================================
  Module      : アクションウィンドウ実行ページ(ActionWindowScheduleExecute.aspx)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
  Copyright   : Copyright W2 Co.,Ltd. 2018 All Rights Reserved.
=========================================================================================================
--%>
<%@ Page Language="C#" MasterPageFile="~/Form/Common/PopupPage.master" AutoEventWireup="true" CodeFile="ActionWindowScheduleExecute.aspx.cs" Inherits="Form_Common_ActionWindowScheduleExecute" %>
										...
										<tr>
											<td>
												<table class="edit_table" cellspacing="1" cellpadding="3" width="550" border="0">
													<tr>
														<td class="detail_title_bg" align="left" width="30%" style="<%= (this.ActionKbn == Constants.FLG_TASKSCHEDULE_ACTION_KBN_ADD_POINT) ? "" : "display:none"%>">ポイントルールスケジュールID</td>
														<td class="detail_title_bg" align="left" width="30%" style="<%= (this.ActionKbn == Constants.FLG_TASKSCHEDULE_ACTION_KBN_PUBLISH_COUPON) ? "" : "display:none" %>">クーポン発行スケジュールID</td>
														<td class="detail_item_bg" align="left">
															<asp:Label ID="lId" runat="server"></asp:Label>
														</td>
													</tr>
													<tr>
														<td class="detail_title_bg" align="left" style="<%= (this.ActionKbn == Constants.FLG_TASKSCHEDULE_ACTION_KBN_ADD_POINT) ? "" : "display:none"%>">ポイントルールスケジュール名</td>
														<td class="detail_title_bg" align="left" style="<%= (this.ActionKbn == Constants.FLG_TASKSCHEDULE_ACTION_KBN_PUBLISH_COUPON) ? "" : "display:none" %>">クーポン発行スケジュール名</td>
														<td class="detail_item_bg" align="left">
												...
												<table class="edit_table" cellspacing="1" cellpadding="3" width="550" border="0">
													...
													<tr>
														...
														<td class="detail_item_bg" align="left">
															<asp:Button ID="btnStart" Text="  付与実行  " runat="server" OnClick="btnStart_Click" />
															<asp:Button ID="btnStop" Text="  付与停止  " runat="server" OnClick="btnStop_Click" />
														</td>
													</tr>
												</table>
												<br />
