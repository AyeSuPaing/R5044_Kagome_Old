<%--
=========================================================================================================
  Module      : ポイントルールスケジュール確認ページ(PointRuleScheduleConfirm.aspx)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
  Copyright   : Copyright W2 Co.,Ltd. 2018 All Rights Reserved.
=========================================================================================================
--%>
<%@ Page Language="C#" MasterPageFile="~/Form/Common/DefaultPage.master" AutoEventWireup="true" CodeFile="PointRuleScheduleConfirm.aspx.cs" Inherits="Form_PointRuleSchedule_PointRuleScheduleConfirm" %>
...
<table cellspacing="0" cellpadding="0" width="791" border="0">
	...
	<tr>
		...
		<td><h2 class="cmn-hed-h2">ポイントルールスケジュール設定詳細</h2></td>
		<%} %>
		<% if (this.ActionStatus == Constants.ACTION_STATUS_CONFIRM){%>
		<td><h2 class="cmn-hed-h2">ポイントルールスケジュール設定確認</h2></td>
		<%} %>
	</tr>
	<tr>
		<td>
											...
											<td>
												...
												<table class="edit_table" cellspacing="1" cellpadding="3" width="758" border="0">
													<tr id="trId" runat="server" visible="false">
														<td class="detail_title_bg" align="left" width="30%">ポイントルールスケジュールID</td>
														<td class="detail_item_bg" align="left">
															<asp:Label ID="lPointRuleScheduleId" runat="server"></asp:Label>
														</td>
													</tr>
													<tr>
														<td class="detail_title_bg" align="left" width="30%">ポイントルールスケジュール名</td>
														<td class="detail_item_bg" align="left">
															<asp:Label ID="lPointRuleScheduleName" runat="server"></asp:Label>
														</td>
													</tr>
													<tr>
													...
													<tr>
														<td class="detail_title_bg" align="left" width="30%">ポイントルール</td>
														<td class="detail_item_bg" align="left">
															<asp:Label ID="lPointRule" runat="server"></asp:Label>
														</td>
													</tr>
													<tr>
													...
													<table class="edit_table" cellspacing="1" cellpadding="3" width="758" border="0">
														...
														<tr>
															...
															<td class="detail_item_bg" align="left" style="height: 28px">
																<input type= "button" onclick="javascript:open_window('<%= WebSanitizer.UrlAttrHtmlEncode(Constants.PATH_ROOT + Constants.PAGE_W2MP_MANAGER_ACTIONWINDOW_SCHEDULEEXECUTE + "?" + Constants.REQUEST_KEY_ACTION_KBN + "=" + Constants.FLG_TASKSCHEDULE_ACTION_KBN_ADD_POINT + "&" + Constants.REQUEST_KEY_MASTER_ID + "=" + this.PointRuleScheduleId) %>','contact','width=850,height=580,top=120,left=420,status=NO,scrollbars=yes');" value="アクションウィンドウを開く" />
															</td>
														</tr>
													</table>
												</div>
