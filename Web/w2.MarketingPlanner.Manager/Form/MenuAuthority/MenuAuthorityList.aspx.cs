...
public partial class Form_MenuAuthority_MenuAuthorityList : BasePage
{
	...
	{
		// 新規登録画面へ遷移
		Response.Redirect( Constants.PATH_ROOT + Constants.PAGE_W2MP_MANAGER_MENU_AUTHORITY_REGISTER + "?" + Constants.REQUEST_KEY_ACTION_STATUS + "=" + Constants.ACTION_STATUS_INSERT);
	}
}