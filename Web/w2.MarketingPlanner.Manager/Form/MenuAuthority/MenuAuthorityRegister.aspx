...
<table cellspacing="0" cellpadding="0" width="791" border="0">
	...
	<tr>
		...
		<td><h2 class="cmn-hed-h2">メニュー権限設定登録</h2></td>
		<%} %>
		<%if (Request[Constants.REQUEST_KEY_ACTION_STATUS] == Constants.ACTION_STATUS_UPDATE) {%>
		<td><h2 class="cmn-hed-h2">メニュー権限設定編集</h2></td>
		<%} %>
	</tr>
	<tr>
		<td>
									...
									<table cellspacing="0" cellpadding="0" border="0">
										<tr>
											<td>
												...
												<asp:Button id="btnConfirm" runat="server" Text="  確認する  " onclick="btnConfirm_Click"></asp:Button></div>
												<table class="edit_table" cellspacing="1" cellpadding="3" width="758" border="0">
													<tr>
														<td class="edit_title_bg" align="center" width="30%">メニュー権限名</td>
