...
<ItemTemplate>
	<div class="page-index-list-wrapper" visible="<%# GetAuthorizedPage(Item.PageIndexSmallMenus).Any() %>" runat="server">
		...
		<asp:Repeater ID="rSmallMenua" DataSource="<%# GetAuthorizedPage(Item.PageIndexSmallMenus) %>" ItemType="w2.App.Common.Manager.Menu.PageIndexListUtility.PageIndexSmallMenu" runat="server">
		<ItemTemplate>
			<li>
				<a href="<%# Item.Href %>">
