...
=========================================================================================================
--%>
<%@ Page language="c#" CodeFile="Default.aspx.cs" Inherits="Default" Title="ログインページ" %>
<%@ Import Namespace="w2.App.Common.Manager" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
	<head runat="server">
		<title>
			<%if (this.IsW2Mp) {%>W2Unified<%} %>
		...
		<link rel="stylesheet" href="<%: this.ResolveClientUrl("~/Css/w2style_mp_v2.css?") + Constants.QUERY_STRING_FOR_UPDATE_EXTERNAL_FILE_URLENCODED %>" media="screen,print" type="text/css" />
	...
	<body onload="window.document.LoginForm.<%: Constants.REQUEST_KEY_MANAGER_LOGIN_ID %>.focus()" class="login <%: this.SiteCssClassName %>">
		<img class="login_mp" src="<%= Constants.PATH_ROOT %>Images/Login/login_MP.svg" alt="logo"/>
		<div id="background" style="position: absolute"></div>
		<div id="loader" style="position: absolute">
			<img src="<%= Constants.PATH_ROOT %>Images/Common/loading.gif" alt="" style="width: 100%" />
		</div>
		<div class="login-box">
			...
			<div class="login-input-box">
				...
				<form id="loginForm" name="LoginForm" method="post" action="<%: Constants.PROTOCOL_HTTPS + Request.Url.Authority + Constants.PATH_ROOT + Constants.PAGE_W2MP_MANAGER_LOGIN %>">
					...
					<div class="login-form-btn">
						<input type="button" id="btnSubmit" value="ログイン" class='<%= this.IsW2Mp  ? "Unified" : "Repeat" %>' />
					</div>
