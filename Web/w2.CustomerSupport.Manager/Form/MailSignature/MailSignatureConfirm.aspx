<%--
=========================================================================================================
  Module      : メール署名設定確認ページ(MailSignatureConfirm.aspx)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
  Copyright   : Copyright W2 Co.,Ltd. 2013 All Rights Reserved.
=========================================================================================================
--%>
<%@ Page Language="C#" MasterPageFile="~/Form/Common/DefaultPage.master" AutoEventWireup="true" CodeFile="MailSignatureConfirm.aspx.cs" Inherits="Form_MailSignature_MailSignatureConfirm" Title="" %>
...
<table cellspacing="0" cellpadding="0" width="791" border="0">
	...
	<tr id="trDetail" runat="server" Visible="False">
		<td><h2 class="cmn-hed-h2">メール署名設定詳細</h2></td>
	</tr>
	<tr id="trConfirm" runat="server" Visible="False">
		<td><h2 class="cmn-hed-h2">メール署名設定確認</h2></td>
	</tr>
	<tr>
		<td>
													...
													<tr>
														<td>
															...
															<table class="detail_table" cellspacing="1" cellpadding="3" width="758" border="0">
																...
																<tr>
																	<td class="detail_title_bg" align="left" width="30%">署名タイトル</td>
																	<td class="detail_item_bg" align="left"><%: this.MailSignatureInfo.SignatureTitle %></td>
																</tr>
																<tr>
																	<td class="detail_title_bg" align="left" width="30%">署名本文</td>
																	<td class="detail_item_bg" align="left"><%= WebSanitizer.HtmlEncodeChangeToBr(this.MailSignatureInfo.SignatureText) %></td>
																</tr>
																<tr>
																	<td class="detail_title_bg" align="left" width="30%">所有者</td>
																	<td class="detail_item_bg" align="left"><%: (this.MailSignatureInfo.OwnerId == "") ? "（共通）" : this.LoginOperatorName %></td>
																</tr>
																<tr>
																	<td class="detail_title_bg" align="left" width="30%">表示順</td>
																	<td class="detail_item_bg" align="left"><%: this.MailSignatureInfo.DisplayOrder %></td>
																</tr>
																<tr>
																	<td class="detail_title_bg" align="left" width="30%">有効フラグ</td>
																	<td class="detail_item_bg" align="left"><%: this.MailSignatureInfo.EX_ValidFlgText %></td>
																</tr>
																<tr id="trDateCreated" runat="server" Visible="False">
																	<td class="detail_title_bg" align="left" width="30%">作成日</td>
																	<td class="detail_item_bg" align="left"><%: DateTimeUtility.ToStringForManager(this.MailSignatureInfo.DateCreated, DateTimeUtility.FormatType.ShortDateHourMinuteSecond2Letter) %></td>
																</tr>
																<tr id="trDateChanged" runat="server" Visible="False">
																	<td class="detail_title_bg" align="left" width="30%">更新日</td>
																	<td class="detail_item_bg" align="left"><%: DateTimeUtility.ToStringForManager(this.MailSignatureInfo.DateChanged, DateTimeUtility.FormatType.ShortDateHourMinuteSecond2Letter) %></td>
																</tr>
																<tr id="trLastChanged" runat="server" Visible="False">
																	<td class="detail_title_bg" align="left" width="30%">最終更新者</td>
																	<td class="detail_item_bg" align="left"><%: this.MailSignatureInfo.LastChanged %></td>
																</tr>
															</table>
