<%--
=========================================================================================================
  Module      : VOC設定確認ページ(IncidentVocConfirm.aspx)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
  Copyright   : Copyright W2 Co.,Ltd. 2013 All Rights Reserved.
=========================================================================================================
--%>
<%@ Page Language="C#" MasterPageFile="~/Form/Common/DefaultPage.master" AutoEventWireup="true" CodeFile="IncidentVocConfirm.aspx.cs" Inherits="Form_IncidentVoc_IncidentVocConfirm" Title="" %>
...
<table cellspacing="0" cellpadding="0" width="791" border="0">
	...
	<tr id="trDetail" runat="server" Visible="False">
		<td>
			<h2 class="cmn-hed-h2">VOC区分設定詳細</h2>
		</td>
	</tr>
	<tr id="trConfirm" runat="server" Visible="False">
		<td>
			<h2 class="cmn-hed-h2">VOC区分設定確認</h2>
		</td>
	</tr>
	<tr>
		<td>
														...
														<td>
															...
															<table class="detail_table" cellspacing="1" cellpadding="3" width="758" border="0">
																...
																<tr id="trVocId" runat="server" Visible="False">
																	<td class="detail_title_bg" align="left" width="30%">VOC番号</td>
																	<td class="detail_item_bg" align="left"><%: this.IncidentVocModel.VocId %></td>
																</tr>
																<tr>
																	<td class="detail_title_bg" align="left" width="30%">表示文言</td>
																	<td class="detail_item_bg" align="left"><%: this.IncidentVocModel.VocText %></td>
																</tr>
																<tr id="trIncType" runat="server">
																	<td class="detail_title_bg" align="left" width="30%">表示順</td>
																	<td class="detail_item_bg" align="left"><%: this.IncidentVocModel.DisplayOrder %></td>
																</tr>
																<tr>
																	<td class="detail_title_bg" align="left" width="30%">有効フラグ</td>
																	<td class="detail_item_bg" align="left"><%: ValueText.GetValueText(Constants.TABLE_CSINCIDENTVOC, Constants.FIELD_CSINCIDENTVOC_VALID_FLG, this.IncidentVocModel.ValidFlg) %></td>
																</tr>
																<tr id="trDateCreated" runat="server" Visible="False">
																	<td class="detail_title_bg" align="left" width="30%">作成日</td>
																	<td class="detail_item_bg" align="left"><%: DateTimeUtility.ToStringForManager(this.IncidentVocModel.DateCreated, DateTimeUtility.FormatType.ShortDateHourMinuteSecond2Letter) %></td>
																</tr>
																<tr id="trDateChanged" runat="server" Visible="False">
																	<td class="detail_title_bg" align="left" width="30%">更新日</td>
																	<td class="detail_item_bg" align="left"><%: DateTimeUtility.ToStringForManager(this.IncidentVocModel.DateChanged, DateTimeUtility.FormatType.ShortDateHourMinuteSecond2Letter) %></td>
																</tr>
																<tr id="trLastChanged" runat="server" Visible="False">
																	<td class="detail_title_bg" align="left" width="30%">最終更新者</td>
																	<td class="detail_item_bg" align="left"><%: this.IncidentVocModel.LastChanged %></td>
																</tr>
															</table>
															<div class="action_part_bottom"><input type="button" onclick="Javascript:history.back();" value=" 　戻る 　" />
																...
																<asp:button id="btnUpdateBottom" runat="server" Text="　更新する　" Visible="False" Width="72px" onclick="btnUpdate_Click"></asp:button></div>
														</td>
													</tr>
													<tr>
														<td><img height="4" alt="" src="../../Images/Common/sp.gif" width="100%" border="0" /></td>
