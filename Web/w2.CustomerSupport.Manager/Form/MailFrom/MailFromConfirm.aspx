<%--
=========================================================================================================
  Module      : メール送信元設定確認ページ(MailFromConfirm.aspx)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
  Copyright   : Copyright W2 Co.,Ltd. 2013 All Rights Reserved.
=========================================================================================================
--%>
<%@ Page Language="C#" MasterPageFile="~/Form/Common/DefaultPage.master" AutoEventWireup="true" CodeFile="MailFromConfirm.aspx.cs" Inherits="Form_MailFrom_MailFromConfirm" Title="" %>
...
<table cellspacing="0" cellpadding="0" width="791" border="0">
	...
	<tr id="trDetail" runat="server" Visible="False">
		<td><h2 class="cmn-hed-h2">メール送信元設定詳細</h2></td>
	</tr>
	<tr id="trConfirm" runat="server" Visible="False">
		<td><h2 class="cmn-hed-h2">メール送信元設定確認</h2></td>
	</tr>
	<tr>
		<td>
													...
													<tr>
														<td>
															...
															<table class="detail_table" cellspacing="1" cellpadding="3" width="758" border="0">
																...
																<tr>
																	<td class="detail_title_bg" align="left" width="30%">表示名</td>
																	<td class="detail_item_bg" align="left"><%: this.MailFromModel.DisplayName %></td>
																</tr>
																<tr>
																	<td class="detail_title_bg" align="left" width="30%">メールアドレス</td>
																	<td class="detail_item_bg" align="left"><%: this.MailFromModel.MailAddress %></td>
																</tr>
																<tr>
																	<td class="detail_title_bg" align="left" width="30%">表示順</td>
																	<td class="detail_item_bg" align="left"><%: this.MailFromModel.DisplayOrder %></td>
																</tr>
																<tr>
																	<td class="detail_title_bg" align="left" width="30%">有効フラグ</td>
																	<td class="detail_item_bg" align="left"><%: this.MailFromModel.EX_ValidFlgText %></td>
																</tr>
																<tr id="trDateCreated" runat="server" Visible="False">
																	<td class="detail_title_bg" align="left" width="30%">作成日</td>
																	<td class="detail_item_bg" align="left"><%: DateTimeUtility.ToStringForManager(this.MailFromModel.DateCreated, DateTimeUtility.FormatType.ShortDateHourMinuteSecond2Letter) %></td>
																</tr>
																<tr id="trDateChanged" runat="server" Visible="False">
																	<td class="detail_title_bg" align="left" width="30%">更新日</td>
																	<td class="detail_item_bg" align="left"><%: DateTimeUtility.ToStringForManager(this.MailFromModel.DateChanged, DateTimeUtility.FormatType.ShortDateHourMinuteSecond2Letter) %></td>
																</tr>
																<tr id="trLastChanged" runat="server" Visible="False">
																	<td class="detail_title_bg" align="left" width="30%">最終更新者</td>
																	<td class="detail_item_bg" align="left"><%: this.MailFromModel.LastChanged %></td>
																</tr>
															</table>
