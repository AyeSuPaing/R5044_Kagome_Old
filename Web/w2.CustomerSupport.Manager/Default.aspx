...
<html xmlns="http://www.w3.org/1999/xhtml" >
	...
	<body onload="window.document.LoginForm.<%: Constants.REQUEST_KEY_MANAGER_LOGIN_ID %>.focus()" class="login <%: this.SiteCssClassName %>">
		<img class="login_cs" src="<%= Constants.PATH_ROOT %>Images/Login/login_CS.svg" alt="logo"/>
			...
			<div class="login-input-box">
				...
				<form id="loginForm" name="LoginForm" method="post" action="<%: Constants.PROTOCOL_HTTPS + Request.Url.Authority + Constants.PATH_ROOT + Constants.PAGE_MANAGER_LOGIN %>">
					...
					<div class="login-form-btn">
						<input type="button" id="btnSubmit" value="ログイン" class='<%= this.IsW2Cs  ? "Unified" : "Repeat" %>' />
					</div>
					...
					<input type="hidden" name="<%= Constants.REQUEST_KEY_CUSTOMER_TELNO %>" value="<%= WebSanitizer.HtmlEncode(Request[Constants.REQUEST_KEY_CUSTOMER_TELNO]) %>" />
