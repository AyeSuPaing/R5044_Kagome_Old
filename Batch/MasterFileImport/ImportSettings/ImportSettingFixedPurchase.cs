/*
=========================================================================================================
  Module      : Import setting fixed purchase(ImportSettingFixedPurchase.cs)
  ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
{
	/// <summary>
	/// Import setting fixed purchase
	/// </summary>
	public class ImportSettingFixedPurchase : ImportSettingBase
	{
		/// <summary>Update key field</summary>
		private static List<string> FIELDS_UPDKEY = new List<string>
		{
			Constants.FIELD_FIXEDPURCHASE_FIXED_PURCHASE_ID,
		};
		...
		{
			Constants.FIELD_FIXEDPURCHASE_LAST_CHANGED,
		};
		...
		/// Constructor
		/// </summary>
		public ImportSettingFixedPurchase()
			: base(
				Constants.CONST_DEFAULT_SHOP_ID,
				Constants.TABLE_FIXEDPURCHASE,
				Constants.TABLE_WORKFIXEDPURCHASE,
				FIELDS_UPDKEY,
				FIELDS_EXCEPT,
		...
		protected override void CheckData()
		{
			...
			if (string.IsNullOrEmpty(errorMessage) == false)
			{
				...
				this.ErrorOccurredIdInfo += CreateIdString(Constants.FIELD_FIXEDPURCHASE_FIXED_PURCHASE_ID);
			}
