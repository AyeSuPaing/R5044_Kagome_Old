/*
=========================================================================================================
  Module      : Import setting fixed purchase shipping(ImportSettingFixedPurchaseShipping.cs)
  ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
{
	/// <summary>
	/// Import setting fixed purchase shipping
	/// </summary>
	public class ImportSettingFixedPurchaseShipping : ImportSettingBase
	{
		/// <summary>Update key field</summary>
		private static List<string> FIELDS_UPDKEY = new List<string>
		{
			Constants.FIELD_FIXEDPURCHASESHIPPING_FIXED_PURCHASE_ID,
			Constants.FIELD_FIXEDPURCHASESHIPPING_FIXED_PURCHASE_SHIPPING_NO,
		};
		...
		/// Constructor
		/// </summary>
		public ImportSettingFixedPurchaseShipping()
			: base(
				Constants.CONST_DEFAULT_SHOP_ID,
				Constants.TABLE_FIXEDPURCHASESHIPPING,
				Constants.TABLE_WORKFIXEDPURCHASESHIPPING,
				FIELDS_UPDKEY,
				FIELDS_EXCEPT,
		...
		protected override void CheckData()
		{
			...
			if (string.IsNullOrEmpty(errorMessage) == false)
			{
				...
				this.ErrorOccurredIdInfo += CreateIdString(Constants.FIELD_FIXEDPURCHASESHIPPING_FIXED_PURCHASE_ID);
				this.ErrorOccurredIdInfo += CreateIdString(Constants.FIELD_FIXEDPURCHASESHIPPING_FIXED_PURCHASE_SHIPPING_NO);
			}
		...
		/// <summary>Validation statement</summary>
		private string ValidationStatement
		{
			get
			{
				...
				if ((Constants.GLOBAL_OPTION_ENABLE == false)
					...
					|| (this.Data.ContainsKey(Constants.FIELD_FIXEDPURCHASESHIPPING_SHIPPING_COUNTRY_ISO_CODE)
						&& ((string)this.Data[Constants.FIELD_FIXEDPURCHASESHIPPING_SHIPPING_COUNTRY_ISO_CODE] == Constants.COUNTRY_ISO_CODE_JP)))
				{
					return "FixedPurchaseShippingInsertUpdate";
				}

				return "FixedPurchaseShippingInsertUpdateGlobal";
			}
		}
	}
}
