/*
=========================================================================================================
  Module      : 商品カテゴリ情報取込設定クラス(ImportSettingProductCategory.cs)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
{
	public class ImportSettingProductCategory : ImportSettingBase
	{
		// 更新キーフィールド
		private static List<string> FIELDS_UPDKEY = new List<string> { Constants.FIELD_PRODUCTCATEGORY_SHOP_ID, Constants.FIELD_PRODUCTCATEGORY_CATEGORY_ID };
		// 更新禁止フィールド（SQL自動作成除外フィールド）
		private static List<string> FIELDS_EXCEPT = new List<string> { Constants.FIELD_PRODUCTCATEGORY_DATE_CHANGED, Constants.FIELD_PRODUCTCATEGORY_LAST_CHANGED };
		...
		// ※更新キーフィールドも含めること
		private static List<string> FIELDS_NECESSARY_FOR_INSERTUPDATE = new List<string> { Constants.FIELD_PRODUCTCATEGORY_SHOP_ID, Constants.FIELD_PRODUCTCATEGORY_CATEGORY_ID };
		// 必須フィールド（Delete用）
		private static List<string> FIELDS_NECESSARY_FOR_DELETE = new List<string> { Constants.FIELD_PRODUCTCATEGORY_SHOP_ID, Constants.FIELD_PRODUCTCATEGORY_CATEGORY_ID };

		/// <summary>
		/// コンストラクタ
		/// </summary>
		/// <param name="shopId">店舗ID</param>
		public ImportSettingProductCategory(string shopId)
			: base(
			shopId,
			Constants.TABLE_PRODUCTCATEGORY,
			Constants.TABLE_WORKPRODUCTCATEGORY,
			FIELDS_UPDKEY,
			FIELDS_EXCEPT,
		...
		protected override void ConvertData()
		{
			...
			foreach (string strFieldName in this.HeadersCsv)
			{
				...
				switch (strFieldName)
				{
					case Constants.FIELD_PRODUCTCATEGORY_SHOP_ID:
					case Constants.FIELD_PRODUCTCATEGORY_CATEGORY_ID:
					case Constants.FIELD_PRODUCTCATEGORY_PARENT_CATEGORY_ID:
		...
		protected override void CheckData()
		{
			...
			{
				sbErrorMessages.Append((sbErrorMessages.Length != 0) ? "\r\n" : "").Append(errorMessage);
				this.ErrorOccurredIdInfo += CreateIdString(Constants.FIELD_PRODUCTCATEGORY_CATEGORY_ID);
			}
