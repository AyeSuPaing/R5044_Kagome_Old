/*
=========================================================================================================
  Module      : Import setting cs message(ImportSettingCsMessage.cs)
  ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
{
	/// <summary>
	/// Import setting cs message
	/// </summary>
	public class ImportSettingCsMessage : ImportSettingBase
	{
		/// <summary>Update key field</summary>
		private static List<string> FIELDS_UPDKEY = new List<string>
		{
			Constants.FIELD_CSMESSAGE_DEPT_ID,
			Constants.FIELD_CSMESSAGE_INCIDENT_ID,
			Constants.FIELD_CSMESSAGE_MESSAGE_NO,
		};
		...
		{
			Constants.FIELD_CSMESSAGE_LAST_CHANGED,
		};
		...
		/// Constructor
		/// </summary>
		public ImportSettingCsMessage()
			: base(
				Constants.CONST_DEFAULT_SHOP_ID,
				Constants.TABLE_CSMESSAGE,
				Constants.TABLE_WORKCSMESSAGE,
				FIELDS_UPDKEY,
				FIELDS_EXCEPT,
		...
		protected override void CheckData()
		{
			...
			if (string.IsNullOrEmpty(errorMessage) == false)
			{
				...
				this.ErrorOccurredIdInfo += CreateIdString(Constants.FIELD_CSMESSAGE_INCIDENT_ID);
				this.ErrorOccurredIdInfo += CreateIdString(Constants.FIELD_CSMESSAGE_MESSAGE_NO);
			}
