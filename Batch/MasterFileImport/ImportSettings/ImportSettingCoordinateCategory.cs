/*
=========================================================================================================
  Module      : コーディネートカテゴリ情報取込設定クラス(ImportSettingCoordinateCategory.cs)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
{
	/// <summary>
	/// コーディネートカテゴリ情報取込設定クラス
	/// </summary>
	public class ImportSettingCoordinateCategory : ImportSettingBase
	{
		/// <summary>
		/// 更新キーフィールド
		/// </summary>
		...
		{
			Constants.FIELD_COORDINATECATEGORY_COORDINATE_CATEGORY_ID,
		};
		/// <summary>
		...
		{
			Constants.FIELD_COORDINATECATEGORY_DATE_CHANGED,
			Constants.FIELD_COORDINATECATEGORY_LAST_CHANGED,
		};
		/// <summary>
		...
		/// コンストラクタ
		/// </summary>
		public ImportSettingCoordinateCategory()
			: base(
			Constants.CONST_DEFAULT_SHOP_ID,
			Constants.TABLE_COORDINATECATEGORY,
			Constants.TABLE_WORKCOORDINATECATEGORY,
			m_fieldsUpdateKey,
			m_fieldsExcept,
		...
		protected override void CheckData()
		{
			...
			if (string.IsNullOrEmpty(errorMessage) == false)
			{
				...
				this.ErrorOccurredIdInfo += CreateIdString(Constants.FIELD_COORDINATECATEGORY_COORDINATE_CATEGORY_ID);
			}
