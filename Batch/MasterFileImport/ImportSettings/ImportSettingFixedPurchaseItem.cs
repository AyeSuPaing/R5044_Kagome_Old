/*
=========================================================================================================
  Module      : Import setting fixed purchase item(ImportSettingFixedPurchaseItem.cs)
  ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
{
	/// <summary>
	/// Import setting fixed purchase item
	/// </summary>
	public class ImportSettingFixedPurchaseItem : ImportSettingBase
	{
		/// <summary>Update key field</summary>
		private static List<string> FIELDS_UPDKEY = new List<string>
		{
			Constants.FIELD_FIXEDPURCHASEITEM_FIXED_PURCHASE_ID,
			Constants.FIELD_FIXEDPURCHASEITEM_FIXED_PURCHASE_ITEM_NO,
		};
		...
		/// Constructor
		/// </summary>
		public ImportSettingFixedPurchaseItem()
			: base(
				Constants.CONST_DEFAULT_SHOP_ID,
				Constants.TABLE_FIXEDPURCHASEITEM,
				Constants.TABLE_WORKFIXEDPURCHASEITEM,
				FIELDS_UPDKEY,
				FIELDS_EXCEPT,
		...
		protected override void CheckData()
		{
			...
			if (string.IsNullOrEmpty(errorMessage) == false)
			{
				...
				this.ErrorOccurredIdInfo += CreateIdString(Constants.FIELD_FIXEDPURCHASEITEM_FIXED_PURCHASE_ID);
				this.ErrorOccurredIdInfo += CreateIdString(Constants.FIELD_FIXEDPURCHASEITEM_FIXED_PURCHASE_ITEM_NO);
			}
