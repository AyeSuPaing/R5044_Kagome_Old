...
namespace w2.Commerce.MallBatch.MailOrderGetter
{
	...
	public class Constants : w2.App.Common.Constants
	{
		...
		public static string MALL_ID = null;
		...
		/// <summary>受注メール取り込み：本文とヘッダーの区切り文字</summary>
		public static string ORDER_MAIL_DELIMITER_HEADER_AND_BODY = "\r\n\r\n";

		/// <summary>Yahoo受注メール: 本文文字コード</summary>
		public static string YAHOO_ORDER_MAIL_BODY_ENCODE_TYPE_STRING = "utf-8";
		/// <summary>Yahoo：注文IDの取込フォーマット(TRUE：ｗ２モールID-yahoo注文ID FALSE：yahoo注文ID)</summary>
		public static bool YAHOO_MALL_ORDERID_FORMAT = false;
		...
		/// <summary>楽天受注メール: 注文キャンセルメール件名</summary>
		public static string RAKUTEN_CANCEL_ORDER_MAIL_SUBJECT = "";
		/// <summary>取り込み保留対象ステータス</summary>
		public static string[] RAKUTEN_RETRY_IMPORT_ORDER_PROGRESS = null;
		/// <summary>取り込み保留対象のリトライ期間(注文完了日時からの経過時間/h)</summary>
		public static int RAKUTEN_RETRY_IMPORT_PERIOD = 0;
		/// <summary>取り込み対象ステータス</summary>
		public static string[] RAKUTEN_IMPORT_ORDER_PROGRESS = null;
		/// <summary>取り込み対象キャンセルメールステータス</summary>
		public static string[] RAKUTEN_CANCEL_ORDER_PROGRESS = null;
		/// <summary>楽天:注文メール取り込み成功メッセージ</summary>
		public const string RAKUTEN_ORDER_MAIL_READ_MESSAGE = "注文メールの取込を1件完了しました。\r\n取込済みの注文メールは詳細1にてご確認頂けます。";
		/// <summary>楽天:注文キャンセルメール取り込み成功メッセージ</summary>
		public const string RAKUTEN_ORDER_CANCEL_MAIL_READ_MESSAGE = "注文キャンセルメールの取込を1件完了しました。\r\n取込済みの注文キャンセルメールは詳細1にてご確認頂けます。";
		/// <summary>楽天:注文キャンセルメール取り込みエラーメッセージ</summary>
		public const string RAKUTEN_ORDER_CANCEL_MAIL_ERROR_MESSAGE = "注文キャンセルメール取込みエラー：キャンセル対象の注文情報が存在しません。\r\nシステム管理者にお問い合わせください。\r\n取込に失敗した注文キャンセルメールは詳細1にてご確認頂けます。";
		...
		/// <summary>金額未確定時の初期値</summary>
		public const decimal RAKUTEN_API_DEFAULT_PRICE = -9999m;
		/// <summary>楽天受注API: お届け時間帯(指定なしの文字列)カンマ区切りで複数指定可能</summary>
		public static string[] RAKUTEN_API_SHIPPING_TERM_NONE_COMMENT = null;
