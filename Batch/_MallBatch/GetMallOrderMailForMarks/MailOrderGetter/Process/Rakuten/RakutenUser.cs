...
namespace w2.Commerce.MallBatch.MailOrderGetter.Process.Rakuten
{
	...
	class RakutenUser : UserModel
	{
		...
		public RakutenUser(personModel rakutenOrderer, int carrierCode)
		{
			...
			this.Tel1 = string.Format("{0}-{1}-{2}", this.Tel1_1, this.Tel1_2, this.Tel1_3);
		...
		private void SetNameKana(string familyNameKana, string firstNameKana)
		{
			...
			this.NameKana = this.NameKana1 + this.NameKana2;
		}
		...
		private string GetSex(string sex)
		{
			...
			if (sex.Contains("男")) return Constants.FLG_USER_SEX_MALE;
			if (sex.Contains("女")) return Constants.FLG_USER_SEX_FEMALE;
