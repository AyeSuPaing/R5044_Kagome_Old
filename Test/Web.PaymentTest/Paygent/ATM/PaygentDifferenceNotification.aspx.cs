...
/// </summary>
public partial class Paygent_ATM_PaygentDifferenceNotification : System.Web.UI.Page
{
	/// <summary>Path root</summary>
	public static string PATH_ROOT = Constants.PROTOCOL_HTTPS + Constants.SITE_DOMAIN + Constants.PATH_ROOT_FRONT_PC;
	/// <summary>Path receive</summary>
	public static string PATH_RECEIVE = "Payment/Paygent/PaymentPaygentPaymentRecv.aspx";
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		if (!IsPostBack)
		{
			tbUrl.Text = PATH_ROOT + PATH_RECEIVE;
			DataBind();
		}
	}
