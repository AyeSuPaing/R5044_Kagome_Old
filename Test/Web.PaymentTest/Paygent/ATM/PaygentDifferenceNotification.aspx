...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PaygentDifferenceNotification.aspx.cs" Inherits="Paygent_ATM_PaygentDifferenceNotification" %>

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
	<title>Paygent ATM決済</title>
	<style>
		table, th, td, tr {
			border: none;
		}
		...
		<div>
			...
			<table>
				...
				<tr>
					<th>決済種別CD</th>
					<td>
						<asp:TextBox ID="tbPaymentType" runat="server" Width="200" Text="01" />
					</td>
				</tr>
				<tr>
					<th>決済ステータス</th>
