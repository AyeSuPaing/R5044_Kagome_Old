...
/// <summary>
/// SBPSRakutenIdSaleReceiver の概要の説明です
/// </summary>
public class SBPSRakutenIdSaleReceiver : SBPSBaseReceiver
{
	/// <summary>
	/// コンストラクタ
	/// </summary>
	/// <param name="requestData">リクエストデータ</param>
	public SBPSRakutenIdSaleReceiver(SBPSApiRequestData requestData)
		: base(requestData)
	{
	}
