/*
=========================================================================================================
  Module      : シングルサインオンテスト用モック（P0078_Mackenyu用）クラス(P0078_Mackenyu.cs)
 ･･･････････････････････････････････････････････････････････････････････････････････････････････････････
...
/// <summary>
/// シングルサインオンテスト用モック（P0078_Mackenyu用）
/// </summary>
public partial class P0078_Mackenyu : System.Web.UI.Page
{
	/// <summary>
	/// ページロード
	/// </summary>
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		this.Nickname = "にっくねーむ";
		this.BirthYear = "1992";
		this.BirthMonth = "8";
		this.BirthDay = "4";
		this.Sex = "1";
		this.Pref = "1";
		this.MailAddr = "mackenyu.test01@w2solution.co.jp";
		this.Tel1 = "080";
		this.Tel2 = "1234";
		this.Tel3 = "5678";
	}
